                ...
                <div style='display:flex; width:100%;flex-direction: row; background-color: peachpuff; '>
                    <div class='InfoArriba' style='float: left; '>
                        ...
                        <div class='InfoIzq' style=" margin: 0 auto;padding: 10px;  border: 1px solid black;">
                            <h6>Tutor:</h6>
                            <input type='text' id='Tutor' value="nombre">
                            <h6>Carrera:</h6>
                  ...
                  <input type = 'text' id = 'PeriodoAtencion'>-->
                        ...
                        <div class='InfoDer' style="margin: 0 auto;padding: 10px;border: 1px solid black;">
                            <h6 style=''>Grupo:</h6>
                            <input style='display:flex;' type='text' id='Grupo' value="grupos">
                            <!--<h6 style = ''">Hora:</h6>
                            ...
                            <div
                                ...
                                <table style="font-size: 11px;background-color: navajowhite;">
                                    <tr style="border: 1px solid #000;text-align: center;">
                                        <th colspan="2' style='border: 1px solid #000;padding: 5px;">Evaluación del
                                            tutorado</th>
                                    </tr>
                                    <tr style="border: 1px solid #000;text-align: center;">
                ...
                <div class="' style='display:flex;flex-direction: column;padding: 5px;">
                    ...
                    <table style="font-size: 9px;background-color: sandybrown;">
                        <tr style="border: 1px solid #000;text-align: center;">
                            ...
                            <TH colspan='2' style='border: 1px solid #000;padding: 5px;'>NÚMERO DE SESIONES CON EL TUTOR
                                (HORA/SESIÓN)</TH>
                            <TH colspan='3' style='border: 1px solid #000;padding: 5px;'>PARTICIPACIÓN EN ACTIVIDADESDE
                                APOYO (NÚMERO DE HORAS DE LA ACTIVIDAD)</TH>
                            <TH colspan='2' style='border: 1px solid #000;padding: 5px;'>CANALIZACIÓN (NÚMERO DE
                                HORA/SESIÓN)</TH>
