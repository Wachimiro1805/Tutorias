...
if($idConf == $id){
    $sql = "UPDATE coordinador_de_tutorias SET nombre = '$nombre', apellido_p = '$apellido_p', appelido_m='$apellido_m', correo='$correo' WHERE coordinador_de_tutorias.id_coordinador_tutorias = $id;";
